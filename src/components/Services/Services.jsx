      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={HeartEmoji}
            heading={"Design"}
            detail={"Figma, Sketch, Photoshop, Adobe, Canva, Giphy "}
          />
        </motion.div>
        ...
        >
          <Card
            emoji={Glasses}
            heading={"Developer"}
            detail={"HTML, CSS, JavaScript, React, Bootstrap, Redux, Firebase"}
          />
        </motion.div>
